...
function Skills() {
  return (
    <div id="skills" className='flex flex-col items-center justify-center pt-24 pb-10 w-scrren'>
      <h1 className='pb-10 text-2xl'>My<strong> Skills</strong></h1>
      <div className='grid grid-cols-2 gap-8 px-5 md:grid-cols-4 lg:grid-cols-6'>
